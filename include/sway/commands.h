...
sway_cmd cmd_workspace_anim_step_ms;
...
sway_cmd cmd_unmark;
sway_cmd cmd_urgent;
sway_cmd cmd_window_open_animation_delay;
sway_cmd cmd_window_open_curve;
sway_cmd cmd_window_open_duration_ms;
sway_cmd cmd_window_close_curve;
